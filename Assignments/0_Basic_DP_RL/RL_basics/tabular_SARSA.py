    ...
    def getQValues(self):
        ...
        while episodes < self.number_of_episodes:
            ...
            while not terminate:
                ...
                # SARSA
                next_q_value = getExpectedActionValue(q_values[next_state], self.epsilon)
...
# model parameters are same as those used in DP algorithms
    ...
    sarsa = tabularSARSA(tabular_RL, number_of_episodes, number_of_steps, learning_rate, learning_rate_decay, epsilon)
